...
export default function Hero() {
  ...
  return (
    <section className="bg-gradient-to-b from-gray-50 to-white overflow-hidden relative">
      {/* Background Paths */}
      <BackgroundPaths />
      
      <div className="container mx-auto px-4 relative z-10">
        <HeroHighlight containerClassName="py-12 md:py-16 rounded-xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-4 max-w-xl">
              <motion.span 
                ...
                className="inline-block px-4 py-1.5 bg-physimed-100 text-physimed-800 rounded-full text-sm font-medium shadow-sm"
              >
              ...
              >
                ...
                <br />
                <Highlight className="mt-2 text-gray-800 dark:text-white">
                  {t("gift_premium")}
                </Highlight>
              </motion.h1>
