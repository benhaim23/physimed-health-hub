  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...dotPattern('rgb(109, 26, 54)'), // physimed color
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block pb-1 px-1 rounded-lg bg-gradient-to-r from-physimed-300 to-physimed-500 dark:from-physimed-400 dark:to-physimed-700`,
        className
      )}
    >
      {children}
